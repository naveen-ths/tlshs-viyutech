...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php if($var[0]=='seo') { ?>
      <li class="nav-item">
        <a class="nav-link"   data-controlsidebar-slide="true" href="{{url('seo/dashboard/logout')}}" role="button">
          <i class="fas fa-th-large"></i>
        </a>
      </li>
      <?php } else { ?>
        <li class="nav-item">
          <a class="nav-link"   data-controlsidebar-slide="true" href="{{url('admin/dashboard/logout')}}" role="button">
            <i class="fas fa-th-large"></i>
          </a>
        </li>
        <?php } ?>
